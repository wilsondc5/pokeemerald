...
static const u8 sText_Description_TXC_Items_Player_No[]          = _("{COLOR 6}{SHADOW 7}The player {COLOR RED}{SHADOW LIGHT_RED}CAN'T{COLOR 6}{SHADOW 7} use battle items.\nHold items are allowed!");
static const u8 sText_Description_TXC_Items_Trainer_Yes[]        = _("{COLOR 6}{SHADOW 7}Enemy trainer can use battle items.");
static const u8 sText_Description_TXC_Items_Trainer_No[]         = _("{COLOR 6}{SHADOW 7}Enemy trainer {COLOR RED}{SHADOW LIGHT_RED}CAN'T{COLOR 6}{SHADOW 7} use battle items.");
